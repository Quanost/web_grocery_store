...
import { AdminLayout, ManageOrders, CreateProduct, Dashboard, ManageProducts, ManageUser, ManageCategories, AdminOrderDetail, AdminPersonal, ReportRevenue, ReportInventory, Question } from './page/admin';
    ...
    <div className="min-h-screen overflow-y-auto font-main ">
      <Routes>
        ...
        <Route path={path.ADMIN} element={<AdminLayout />}>
          ...
          <Route path={path.REPORT_REVENUE} element={<ReportRevenue />} />
          <Route path={path.REPORT_INVENTORY} element={<ReportInventory />} />
          <Route path={path.QUESTTION} element={<Question />} />
        </Route>
