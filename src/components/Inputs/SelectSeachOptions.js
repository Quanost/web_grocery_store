...
export default function SelectSeachOptions({ control, name, placeholder, options, messageError = "Giá trị không được trống", disabled = false }) {
                    ...
                    render={({ field }) => (
                        <Dropdown
                            ...
                            pt={{
                                ...
                                filterInput: 'rounded-lg h-full pl-5 w-full justify-center items-center placeholder',
                                filterIcon: '-mt-2',
